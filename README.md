...
InteractiveTest 是 [ErisPulse](https://github.com/ErisPulse/ErisPulse) 的官方功能测试模块，用于验证和演示 ErisPulse SDK 提供的交互式对话能力与 OneBot12 消息构建器（SendDSL）功能。适合开发者在接入适配器后快速验证各项功能是否正常工作。
